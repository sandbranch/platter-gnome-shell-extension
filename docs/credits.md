...
| ✔ | Corner (Left) | Jordi Puigdellivol Hernandez (BadChoice) | NowPlaying | GPL-3.0 | [link](https://launchpad.net/covergloobus) |
| ✔ | Corner (Right) | Jordi Puigdellivol Hernandez (BadChoice); mirrored by Platter | NowPlaying | GPL-3.0 | [link](https://launchpad.net/covergloobus) |
|  | Corner (4-corner pack) | Naf71 (Dr Naf) | NowPlaying | CC BY-NC-SA 3.0 | [link](https://web.archive.org/web/20150910155550/http://gnome-look.org/content/show.php/Corner+Covergloobus?content=144317) |
